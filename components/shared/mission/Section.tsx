    ...
    <>
        ...
        <div className="p-container  bg-white">
          <div className=" lg:px-[96px] space-y-8">
            <div className=" space-y-3">
              <h5 className="h5 font-bold">Missione Sociale</h5>
            </div>
      ...
      <div className=" p-container flex flex-col lg:flex-row gap-10 bg-transparent">
        ...
        <div className=" flex-1 space-y-4">
          <h2 className=" h2">
            Più di una semplice app, un compagno di viaggio affidabile.
          </h2>

          <h5 className=" h5">
            Whable è più di un'app: è una community che trasforma
            l'accessibilità in libertà, offrendo informazioni affidabili e
            strumenti per scoprire luoghi dove vivere esperienze outdoor in
